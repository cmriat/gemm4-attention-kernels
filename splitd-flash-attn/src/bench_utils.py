# This file is copied from https://github.com/Dao-AILab/flash-attention/blob/main/flash_attn/cute/bench_utils.py
...
def flops(
    ...
    if causal:
        ...
        if window_size == (None, None):
            ...
            col_right = (
                torch.minimum(row_idx + seqlen_k - seqlen_q + window_size[1], torch.tensor(seqlen_k - 1))
...
def bandwidth_fwd_bytes(batch, nheads, nheads_kv, seqlen_q, seqlen_k, headdim, headdim_v, dtype_bytes=2, has_qv=False):
...
def bandwidth_bwd_bytes(batch, nheads, nheads_kv, seqlen_q, seqlen_k, headdim, headdim_v, dtype_bytes=2):
