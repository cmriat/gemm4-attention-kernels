# This file is copied from https://github.com/Dao-AILab/flash-attention/blob/main/flash_attn/cute/flash_bwd_preprocess.py
...
class FlashAttentionBackwardPreprocess:
    ...
    def _setup_attributes(self):
        ...
        gmem_k_block_size = (
            ...
            else (64 if self.head_dim_v_padded % 64 == 0 else (32 if self.head_dim_v_padded % 32 == 0 else 16))
        )
    ...
    def __call__(
        ...
        if const_expr(mCuSeqlensQ is not None):  # *  user VarlenScheduler
    ...
    def kernel(
        ...
        if work_tile.is_valid_tile:
            ...
            for m in cutlass.range(cute.size(tOrO.shape[1]), unroll_full=True):  # ?  why use  unroll_full  here?
